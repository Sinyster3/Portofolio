          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div>
              ...
              <p className="mt-3 text-gray-700 leading-relaxed">
                I am a web developer and data analyst with a passion for
                transforming complex data into meaningful insights and creating
                functional, user-focused digital solutions. I have experience
                developing web applications through internships, academic
                projects, and personal projects using modern web technologies
                such as HTML, CSS, JavaScript, React, Tailwind CSS, and Laravel.
                I enjoy solving problems, collaborating with teams, and
                continuously improving my technical skills to build impactful
                digital products.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-3 text-gray-700 leading-relaxed">
                I believe that great websites are built by combining clean code,
                responsive design, and user-centered experiences. In every
                project, I focus on understanding user needs, writing
                maintainable code, and creating interfaces that are simple,
                accessible, and visually engaging. I am committed to continuous
                learning and always strive to improve both my technical and
                communication skills. My goal is to deliver clean, efficient,
                and scalable solutions that not only meet technical requirements
          ...
          <div>
            ...
            <div className="mt-5 grid sm:grid-cols-2 gap-x-10 gap-y-4 text-gray-800">
              <InfoRow
                icon={<IconId />}
                label="Name"
                value="Mohammad Habli Islamy Sholihin"
              />
              <InfoRow
                icon={<IconCap />}
                label="Education"
  ...
  return (
    <div className="relative rounded-2xl bg-cyan-600/10 border border-cyan-200 px-6 py-8">
      ...
      <div className="text-center">
        <h4 className="text-cyan-700 font-semibold tracking-wide">{title}</h4>
        <p className="mt-1 text-sm text-cyan-900/80">{desc}</p>
      </div>
    </div>
  );
}
