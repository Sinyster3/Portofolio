...
export const portfolioData = {
  projects: [
    ...
    },
    {
      id: 2,
      title:
        "Perbandingan Algortma Gradient Boosting dan Random Forest Dalam Prediksi Pinjaman Nasabah ke Bank",
      date: "Oktober 2025",
    ...
    },
    {
      ...
      figma:
        "https://www.figma.com/proto/Q6KfOiMET6wjMd5dhdaX95/TECHNOPHORIA-ECOMMERCE?node-id=128-1686&starting-point-node-id=128%3A1686&t=BsQyub9z6JPsMUEi-1",
      demo: "",
    ...
    },
    {
      ...
      figma:
        "https://www.figma.com/proto/XGte35lSk4fRLtjeq37PsQ/UI-UX-PANDEYAN-PROJECT?node-id=471-50&starting-point-node-id=471%3A50&t=iYf7yhhKfQGF2jQf-1",
      technologies: ["HTML", "CSS", "JavaScript", "Boostrap", "PHP", "MySQL"],
      features: [
        "Responsive Design",
        "Simple UI",
    ...
    },
    {
      ...
      figma:
        "https://www.figma.com/design/HQYzmoMufwDHoWCF95LCjB/Pelacakan-Plat-Nomor-Kendaraan?node-id=0-1&t=ZWyOZhiKpnhACGGG-1",
      demo: "",
    ...
    },
    {
      ...
      github: "", //https://github.com/username/portfolio
      technologies: ["Naive Bayes", "Google Colab", "Pandas", "NumPy"],
      features: [
  ...
  certificates: [
    ...
    },
    {
      id: 5,
      title:
        "The Role of Machine Learning in Supporting Digital Indonesia 2024",
      image: cert5,
      link: "#",
    },
    {
  ...
  const tabs = useMemo(
    () => [
      ...
      },
      {
        key: "certificates",
        label: "Certificates",
        icon: <IconBadge className="w-5 h-5" />,
      },
      ...
      <section className="bg-white px-6 lg:px-12 xl:px-20 py-14" id="showcase">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="mt-2 text-gray-700 text-sm md:text-base max-w-2xl mx-auto">
            ...
            section represent a milestone in my continuous learning path
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto mt-6">
          ...
          <div className="mt-6 rounded-2xl bg-cyan-200/60 p-6 md:p-8">
            {activeTab === "projects" && (
              <ProjectsGrid data={portfolioData.projects} />
            )}
...
function ProjectCard({ item }) {
  return (
    <div className="bg-white rounded-xl shadow-sm border border-cyan-100 overflow-hidden transition hover:-translate-y-1 hover:shadow-md">
      ...
      <div className="p-4">
        <h4 className="font-bold text-gray-900 leading-snug text-sm">
          {item.title}
        </h4>
...
function ToolsGrid({ data }) {
  return (
    <div>
      ...
      {data.length === 0 && (
        <div className="text-center text-cyan-900/70 py-10">
          Belum ada tools.
        </div>
      )}
    </div>
